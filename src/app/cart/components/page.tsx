  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 px-4 text-center">
        ...
        <Link href="/" className="mt-4 text-sm text-muted-foreground hover:text-primary transition-colors">
          Back to Home
        </Link>
      </div>);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Trust Badges - Cart Page */}
          <div className="grid grid-cols-3 gap-3 pt-4">
            {[
            { icon: 'TruckIcon', label: 'Free shipping on $49+' },
          ...
          <div className="pt-4">
            ...
            <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2">
              {[
              {
                name: 'JBL Clip 4 Portable Speaker',
                price: 49.95,
                image: "https://images.unsplash.com/photo-1612115043286-4e7f5a14abfd",
                alt: 'Small portable JBL speaker in red on white background, compact audio device'
              },
              {
                name: 'Anker 65W USB-C Charger',
                price: 29.99,
                image: "https://images.unsplash.com/photo-1688864606835-219d43661fcb",
                alt: 'White USB-C charger adapter on white surface, tech accessory product photo'
              },
              {
                name: 'Moleskine Classic Notebook',
                price: 19.99,
                image: "https://images.unsplash.com/photo-1591305097470-0fad344325aa",
                alt: 'Black hardcover notebook on wooden desk with pen, stationery flat lay'
              }].
              map((rec) =>
              <Link key={rec.name} href="/products" className="flex-shrink-0 w-40 group">
                  <div className="bg-white rounded-xl overflow-hidden card-shadow product-card-hover">
                    ...
                    <div className="p-2.5">
                      ...
                      <p className="text-sm font-800 price-deal">${rec.price.toFixed(2)}</p>
                    </div>
                  </div>
                </Link>
              )}
