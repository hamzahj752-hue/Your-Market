      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 pb-24 lg:pb-0">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="bg-card rounded-xl border border-border/50 mb-4">
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 pb-24 lg:pb-0">
          <div className="max-w-lg mx-auto px-4 sm:px-6">
            <section className="bg-card rounded-xl border border-border/50 mb-4">
              <div className="p-4">
                <div className="flex items-center gap-3">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center">
                    <Icon name="UserCircleIcon" size={34} className="text-primary" />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs text-primary font-700 mb-0.5">YourMarket Account</p>
                    <h1 className="text-lg font-800 text-foreground">Guest</h1>
            ...
            <section className="bg-card rounded-xl border border-border/50 p-4 mb-4">
              <div className="text-center max-w-sm mx-auto">
                ...
                <h2 className="text-base font-800 mb-2">Sign in to YourMarket</h2>
    ...
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="p-4 md:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-primary font-700 mb-0.5">Welcome back</p>
                  <h1 className="text-lg md:text-xl font-800 text-foreground truncate">
                    {profile.name}
                  </h1>
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl border border-border text-xs font-700 hover:bg-muted transition-colors self-start shrink-0"
                >
          ...
          <section className="mb-4 space-y-2">
            <button
              type="button"
              onClick={openProfile}
              className="w-full bg-white rounded-lg border border-border/50 p-3 flex items-center gap-3 text-left"
            >
              <div className="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                <Icon name="UserIcon" size={18} className="text-primary" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-700">My Profile</p>
                <p className="text-xs text-muted-foreground mt-0.5">
          ...
          <section className="pb-4">
            <div className="bg-card rounded-xl border border-border/50 p-3.5 md:p-5">
              <h2 className="text-base md:text-lg font-800">Account Security</h2>
          ...
          <section className="pb-8">
            <div className="bg-card rounded-xl border border-border/50 p-3.5 md:p-5">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h2 className="text-base md:text-lg font-800">My Addresses</h2>
                  <p className="text-xs text-muted-foreground mt-1">
              ...
              {addresses.length === 0 ? (
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {addresses.map((addr) => (
                    <div key={addr.id} className="border border-border/60 rounded-lg p-3">
      ...
      {showProfile && (
        <div className="fixed inset-0 z-[100] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-card rounded-xl shadow-2xl p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-800">My Profile</h2>
              <button
                type="button"
            ...
            <form onSubmit={handleProfileSave} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-background px-3 py-2.5 font-800 outline-none focus:ring-2 focus:ring-primary/20"
                />
              </div>
              <div className="grid sm:grid-cols-2 gap-3">
                <div>
      ...
      {showAddressForm && (
        <div className="fixed inset-0 z-[100] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-[520px] sm:max-w-[540px] lg:max-w-[560px] bg-card rounded-xl shadow-2xl max-h-[90dvh] flex flex-col overflow-hidden">
            <div className="flex items-center justify-between px-5 pt-5 pb-3 shrink-0">
              <h2 className="text-base font-800">
            ...
            <form
              ...
              className="space-y-3.5 px-5 pb-0 overflow-y-auto flex-1 min-h-0"
            >
              <div>
              ...
              <div className="py-3 border-t border-border flex gap-3 shrink-0 sticky bottom-0 bg-card">
                <button
                  type="button"
                  onClick={handleAddressClose}
                  disabled={addressSaving}
                  className="flex-1 h-10 rounded-xl bg-muted font-700 disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={addressSaving}
                  className="flex-1 h-10 rounded-xl bg-primary text-primary-foreground font-700 justify-center inline-flex items-center disabled:opacity-50"
                >
