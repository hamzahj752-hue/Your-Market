...
const defaultTestimonials: DisplayTestimonial[] = [
  {
    quote:
      "ShopAll completely changed how I shop online. The prices are unbeatable and delivery is always on time. I've ordered over 40 times in the past year.",
    author: 'Priya Sharma',
    role: 'Verified Buyer',
  ...
  {
    quote:
      "The return process is hassle-free and customer service actually picks up. I switched from Amazon and haven't looked back since.",
    author: 'Marcus Johnson',
    role: 'Verified Buyer',
    avatar: 'https://img.rocket.new/generatedImages/rocket_gen_img_18d854688-1763295573707.png',
    avatarAlt:
      'African American man professional headshot, confident smile, bright office background',
    rating: 5,
  },
  {
    quote:
      'Found my whole home renovation shopping list in one place. The product descriptions are detailed and the photos are accurate — no surprises.',
    author: 'Linda Chen',
    role: 'Verified Buyer',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/3 flex-shrink-0">
            ...
            <h2
              id="trust-heading"
              className="text-section-title font-800 text-foreground leading-tight mb-6"
            >
